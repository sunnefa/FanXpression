/***********************
    ...
    ********************
    ...
    Current file: fanx_admin/js/tinyupload.js
...
function tinyupload(field_name, url, type, win){
	...
	*/
	...
	CONFIG
	*/
        var the_url = document.location.protocol + '//' + document.location.hostname + document.location.pathname;
        the_url = the_url.replace('index.php', '');
	var pathToPhp = the_url + '/js/tinyupload.php';
